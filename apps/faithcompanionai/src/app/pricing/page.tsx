...
export default function PricingPage() {
  ...
  return (
    <>
      ...
      <section className="mt-4 overflow-hidden rounded-[28px]" style={{ border: '1px solid rgba(255,255,255,0.1)' }}>
        <div className="overflow-x-auto">
          <div className="min-w-[480px]">
            ...
            <div className="grid grid-cols-3 items-center border-t border-white/10 py-4" style={{ background: 'rgba(139,92,246,0.1)' }}>
              <div className="px-5 text-xs text-white/40">Start whenever you are ready</div>
              <div className="px-5 text-center">
                <Link href="/biblequiz" className="text-xs text-white/55 underline underline-offset-2 transition hover:text-white/80">
              ...
              <div className="px-5 text-center">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-violet-600 to-orange-500 px-4 py-1.5 text-xs font-semibold text-white transition hover:opacity-95"
                >
